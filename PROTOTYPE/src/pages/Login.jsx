...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-between overflow-hidden relative">
        ...
        >
          <div>
            ...
            <div className="flex items-center gap-3.5">
              <div className="w-11 h-11 rounded-xl bg-blue-600 flex items-center justify-center text-white shadow-xl shadow-blue-600/40">
                <span className="font-extrabold text-2xl tracking-tight">S</span>
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-2xl font-extrabold text-white tracking-tight">StatIQ</span>
                  <span className="text-xs bg-blue-500/25 text-blue-300 font-bold px-2.5 py-0.5 rounded-full border border-blue-500/30">
                    SIH 2026 Prototype
                  </span>
                </div>
                <p className="text-sm text-slate-400 font-medium">AI-Powered Competency &amp; Learning Platform</p>
              </div>
            </div>
      ...
      {/* Footer Prototype attribution */}
      <footer className="py-4 px-6 text-center text-xs text-slate-400 bg-slate-950 border-t border-slate-900 relative z-20">
        <p>
          StatIQ is a prototype created for Smart India Hackathon (SIH 2026) Problem Statement SIH26101.
          Not an official Government of India or iGOT product.
        </p>
      </footer>
    </div>
  );
