...
create table if not exists public.competency_gaps (
  ...
  required_score double precision not null,
  ...
  constraint competency_gaps_competency_id_fkey foreign KEY (competency_id) references competencies (id),
  constraint competency_gaps_user_id_fkey foreign KEY (user_id) references user_profiles (id)
