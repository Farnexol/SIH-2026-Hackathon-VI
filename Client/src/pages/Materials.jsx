        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-linear-to-br from-slate-900 via-slate-900 to-indigo-950 text-white shadow-xl flex flex-col lg:flex-row lg:items-center justify-between gap-8 border border-slate-800 relative overflow-hidden">
          ...
          <div className="space-y-4 max-w-2xl relative z-10">
            ...
            <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
              Samarth digests raw sampling guidelines, national accounting notes, and NSS instruction schedules. It analyzes semantic depth, maps concepts to Official Statistical System competencies, and generates high-fidelity multiple-choice diagnostics.
            </p>
